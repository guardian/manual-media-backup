...
class PlutoCommunicator(override val plutoBaseUri:String, override val plutoUser:String, override val plutoPass:String)
...
trait PlutoCommunicatorFuncs {
  ...
  val plutoUser:String
  val plutoPass:String
